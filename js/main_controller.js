...
const mainController = {
    ...
    loadInitialData: function() {
        ...
        console.log('loadInitialData - Products found:', products.length);
    ...
    loadProduct: function(product) {
        ...
        // Set form values
        document.getElementById('model-input').value = product.model || '';
        ...
        if (statusSelect) {
            for (let i = 0; i < statusSelect.options.length; i++) {
                if (statusSelect.options[i].value === product.status) {
